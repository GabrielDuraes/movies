...
<head>
    ...
    <title>Categoria <?php echo $categoria; ?></title>
...
<?php    
    ...
    $Movie1 = new movie();
    $moviesNum = 0;
    $Movie1 = $Movie1->ReadAllMoviesCategoria($categoria);
        foreach($Movie1 as $movie1){
            $moviesNum += 1; 
            }
    $pagina = intval($_GET['pagina']);
    $num_paginas = ceil($moviesNum/$item_por_pag);
  ...
  $Movie = new Movie();
  $Movie = $Movie->ReadAll_Paginacao_Categoria($item_por_pag, $item, $categoria);
...
<div class="container" style="min-height: 600px;">
  <br><br>
  <h1 class="text-center animated pulse infinite">Categoria <?php echo $categoria; ?></h1>
  <br>
...
<nav class="my-4">
    <ul class="pagination pagination-circle">
        ...
        <!--First-->
        <li class="page-item"><a class="page-link" href="categorias.php?pagina=0" style="color: black; font-weight: 500;">First</a></li>

        <!--Arrow left-->
        <li class="page-item">
            <a style="color: black;" class="page-link" href="categorias.php?pagina=<?php echo $paginas; ?> aria-label="Previous">
        ...
        <?php for($i=0; $i<$num_paginas; $i++){ 
            $estilo =" ";
            if($pagina == $i){ 
                $estilo = "background: #4a148c; color: white;";
            }
        ?>
        <!--Numbers-->
        
        <li class="page-item"><a class="page-link" style="color: black; <?php echo $estilo; ?> font-weight: 500;"   href="categorias.php?pagina=<?php echo $i; ?>&categoria=<?php echo $categoria; ?>";?"><?php echo $i+1; ?></a></li>
        <?php  } ?>

        <!--Arrow right-->
        <li class="page-item">
            <a style="color: black;" class="page-link" href="categorias.php?pagina=<?php echo $paginas+1; ?> aria-label="Next">
                <i class="fa fa-forward" aria-hidden="true"></i>
            </a>
        </li>

        <!--First-->
        <li class="page-item"><a class="page-link" href="categorias.php?pagina=<?php echo $num_paginas-1; ?>" style="color: black; font-weight: 500;">Last</a></li>
