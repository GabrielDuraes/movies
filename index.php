...
<?php
  ...
  $Movie = new Movie();
  $Movie = $Movie->ReadAll_Paginacao($item_por_pag, $item);
...
<div class="container">
  <br><br>
  <h1 class="text-center animated pulse infinite">Todas as Categorias</h1>
  <br>
...
<nav class="my-4">
    <ul class="pagination pagination-circle">
        ...
        <!--First-->
        <li class="page-item"><a class="page-link" href="index.php?pagina=0" style="color: black; font-weight: 500;">First</a></li>

        <!--Arrow left-->
        <li class="page-item">
            <a style="color: black;" class="page-link" href="index.php?pagina=<?php echo $paginas; ?> aria-label="Previous">
        ...
        <li class="page-item"><a class="page-link" style="color: black; <?php echo $estilo; ?> font-weight: 500;"   href="index.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
        <?php  } ?>

        <!--Arrow right-->
        <li class="page-item">
            <a style="color: black;" class="page-link" href="index.php?pagina=<?php echo $paginas+1; ?> aria-label="Next">
                <i class="fa fa-forward" aria-hidden="true"></i>
            </a>
        </li>

        <!--First-->
        <li class="page-item"><a class="page-link" href="index.php?pagina=<?php echo $num_paginas-1; ?>" style="color: black; font-weight: 500;">Last</a></li>
...
<!--/.Footer-->
  ...
  $('#PEsquisar').click(function(e) {
      ...
      window.location = "pesq_all.php?pesq="+pesq; 
      }
  });
